...
$('<div class="quantity-nav"><div class="quantity-button quantity-up"><li><img src="images/plus.svg" alt=""></li></div><div class="quantity-button quantity-down"><li><img src="images/minus.svg" alt=""></li></div></div>').insertAfter('.quantity input');
